...
@interface MainViewController : UIViewController <BLEDiscoveryDelegate, BLEServiceDelegate, BLEServiceDataDelegate>
...
@property (strong, nonatomic) NZGraphView *accelerometerView;
